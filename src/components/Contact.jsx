    ...
    <>
      <div className='contact-wrapper'>
        ...
        <div className='contact-links-wrapper'>
          <a className="contact-links" href="https://www.linkedin.com/in/daniel-south-6508a518/" aria-label="Link to Daniel South Linkedin page" target="_blank">
          <FontAwesomeIcon icon={faLinkedin} alt="linkedin logo" className="linkedin-logo-contact" />
          </a>
          <a className="contact-links" href="mailto:southd12@gmail.com" aria-label="Link to email Daniel South" target="_blank">
